...
import { faAngleDown, faBars, faXmark, faCircleInfo, faPhone, faEnvelope } from "@fortawesome/free-solid-svg-icons";
...
export const githubIcon = <FontAwesomeIcon icon={faGithub} size="2x" />
export const infoIcon = <FontAwesomeIcon icon={faCircleInfo} size="2x" />
